...
export default defineComponent({
  ...
  setup (_, { emit }) {
    ...
    const showLoginAgain = ref(false)
    ...
    /*const validatePhone = async () => {
      ...
      console.log('PHONE', formOriginal.phone, $helper.formatPhone(form.phone, 'db'))
      if (formOriginal.phone === $helper.formatPhone(form.phone, 'db')) {
        return true
      }
      const hasUsers = await dispatch('user/search', {
        field: 'phone',
      ...
      // form.phone = $helper.formatPhone(form.phone, 'db')
      return true;
    }*/
    ...
    watchEffect(() => {
      if (form.phone) {
        form.phone = $helper.formatPhone(form.phone)
      }
    })
